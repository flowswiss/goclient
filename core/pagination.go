...
var CursorAll = Cursor{NoFilter: 1}
...
// Links provides direct URLs to the individual pages
type Links struct {
...
// ParsePagination creates a Pagination object from the headers of the given http response.
