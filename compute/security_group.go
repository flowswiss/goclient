...
func (s SecurityGroupService) Update(
	ctx context.Context,
	req SecurityGroupUpdateReq,
) (securityGroup SecurityGroup, err error) {
...
func getSpecificSecurityGroupPath(securityGroupID uint) string {
	return core.Join(securityGroupsSegment, securityGroupID)
}
