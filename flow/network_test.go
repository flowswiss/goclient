...
func TestNetworkService_List(t *testing.T) {
	...
	serveMux.HandleFunc(path.Join("/v4/compute/networks"), func(res http.ResponseWriter, req *http.Request) {
...
func TestNetworkService_Get(t *testing.T) {
	...
	serveMux.HandleFunc(path.Join("/v4/compute/networks/1"), func(res http.ResponseWriter, req *http.Request) {
		assertMethod(t, req, http.MethodGet)
